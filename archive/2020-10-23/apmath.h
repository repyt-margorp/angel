...
#define APMATH_BASE_BIT_LENGTH		(8 * sizeof(apmath_base_t))
#define APMATH_BASE_HALF_BIT_LENGTH	(APMATH_BASE_BIT_SIZE / 2)
#define APMATH_BASE_FULL		(APMATH_BASE_MAX)
#define APMATH_BASE_HALF_FULL		(APMATH_BASE_FULL >> APMATH_BASE_BIT_HALF_SIZE)

#define APMATH_SUPER_ZERO		((apmath_super_t) 0)
#define APMATH_SUPER_ONE		((apmath_super_t) 1)
#define APMATH_SUPER_MAX		((apmath_super_t) -1)
#define APMATH_SUPER_BIT_LENGTH		(8 * sizeof(apmath_super_t))
#define APMATH_SUPER_HALF_BIT_LENGTH	(APMATH_SUPER_BIT_SIZE / 2)
#define APMATH_SUPER_FULL		(APMATH_SUPER_MAX)
#define APMATH_SUPER_HALF_FULL		(APMATH_SUPER_FULL >> APMATH_SUPER_BIT_HALF_SIZE)

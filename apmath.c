...
//#define APMATH_BASE_ARRAY_INVERSE_MAY_GO_OVER
 ...
 */
#ifdef APMATH_BASE_ARRAY_INVERSE_MAY_GO_OVER
...
out:
#else // APMATH_BASE_ARRAY_INVERSE_MAY_GO_OVER
	/* do nothing */
#endif // APMATH_BASE_ARRAY_INVERSE_MAY_GO_OVER
